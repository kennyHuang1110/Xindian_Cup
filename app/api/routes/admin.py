...
def create_team(payload: TeamAdminCreate, db: Session = Depends(get_db)) -> Team:
...
def update_team(team_id: int, payload: TeamAdminUpdate, db: Session = Depends(get_db)) -> Team:
